    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('normalized_amount_inr', models.DecimalField(blank=True, decimal_places=2, max_digits=12)),
                ('expense_date', models.DateField()),
                ('split_type', models.CharField(choices=[('equal', 'Equal'), ('exact', 'Exact Amount'), ('percentage', 'Percentage'), ('share', 'Share Ratio')], default='equal', max_length=15)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amount', models.DecimalField(decimal_places=4, max_digits=12)),
                ('amount_inr', models.DecimalField(blank=True, decimal_places=2, max_digits=12)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('pending', 'Pending Review'), ('processed', 'Processed'), ('failed', 'Failed')], default='pending', max_length=15)),
